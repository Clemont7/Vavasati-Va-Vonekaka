  ...
  return (
    <footer className="border-t border-stone-200/60 bg-cream px-4 pb-10 pt-20">
      <div className="container-max mx-auto flex max-w-xl flex-col items-center text-center">
        ...
        <h3 className="font-display text-4xl font-bold text-terracotta md:text-5xl">
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          {footerSocials.map((social) => (
            <a
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full border border-stone-300 text-stone-400 transition-colors hover:border-terracotta hover:text-terracotta"
        ...
        <div className="mt-10 space-y-2">
          ...
          <a
            ...
            className="block text-sm font-medium text-terracotta transition-colors hover:text-terracotta"
          >
            {contactInfo.email}
          </a>
